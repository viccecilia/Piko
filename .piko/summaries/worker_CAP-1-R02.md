...
## Changes
- Generated replacement/deprecation policy.

## Verification Run By Worker
- Replacement policy JSON parse probe passed.
...
## Risks And Notes
- Some CAP round files contain mojibake; CAP-BATCH-WORKER.md and CAP-INDEX.md were used as the controlling intent.
