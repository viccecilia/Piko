# Worker Summary: CONNECTOR-1-R02
...
- Deleted files: none
- Behavioral changes: Added manifest examples for approved endpoint, Steam/market, Reddit/SERP/community, MediaWiki, and AI-tools sources.
- Primary artifact: artifacts/connector_registry/connector_manifest_examples.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/connector_manifest_examples.json"
}
`
