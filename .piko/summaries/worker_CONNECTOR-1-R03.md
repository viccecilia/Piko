# Worker Summary: CONNECTOR-1-R03
...
- Deleted files: none
- Behavioral changes: Added retained/prohibited field policy, timeout/rate-limit defaults, HTML/crawler denial policy.
- Primary artifact: artifacts/connector_registry/source_governance_policy.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/source_governance_policy.json"
}
`
