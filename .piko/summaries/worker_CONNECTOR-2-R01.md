# Worker Summary: CONNECTOR-2-R01
...
- Deleted files: none
- Behavioral changes: Added credential policy artifact and redaction guardrail probe for sensitive key names.
- Primary artifact: artifacts/connector_registry/credential_policy.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/credential_policy.json"
}
`
