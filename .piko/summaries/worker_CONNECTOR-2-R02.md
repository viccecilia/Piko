# Worker Summary: CONNECTOR-2-R02
...
- Deleted files: none
- Behavioral changes: Added permission audit policy that allows only dry_run and verify_contract by default.
- Primary artifact: artifacts/connector_registry/permission_audit_policy.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/permission_audit_policy.json"
}
`
