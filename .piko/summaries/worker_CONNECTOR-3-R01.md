# Worker Summary: CONNECTOR-3-R01
...
- Deleted files: none
- Behavioral changes: Added gaming connector pack with approved endpoint, Steam summary, Reddit, SERP, MediaWiki, JP, and KR candidate connectors.
- Primary artifact: artifacts/connector_registry/gaming_connector_pack.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/gaming_connector_pack.json"
}
`
