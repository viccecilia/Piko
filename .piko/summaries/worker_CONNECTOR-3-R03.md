# Worker Summary: CONNECTOR-3-R03
...
- Deleted files: none
- Behavioral changes: Added cross-domain routing helper and routing artifact with safe_fail for unknown domains/source types.
- Primary artifact: artifacts/connector_registry/connector_routing.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/connector_routing.json"
}
`
