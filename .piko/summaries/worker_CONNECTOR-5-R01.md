# Worker Summary: CONNECTOR-5-R01
...
- Deleted files: none
- Behavioral changes: Added /connectors read-only API, routing/plan probes, and HTML operator window.
- Primary artifact: artifacts/connector_registry/operator_connector_surface.json
...
`json
{
  ...
  "artifact": "artifacts/connector_registry/operator_connector_surface.json"
}
`
