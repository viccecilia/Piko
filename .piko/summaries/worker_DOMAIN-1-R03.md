...
- Deleted files: none
- Behavioral changes: Added GenericSourceSignal, NeedCluster, OpportunityScore, EvidenceTrace contracts and migration map.
...
## Sample Output
``json
{"migration_map":{"GameHeatSignal":"GenericSourceSignal","PlayerQuestionSignal":"NeedCluster","ToolCandidateSignal":"GenericSourceSignal"}}
``
...
## Next Recommendation
- Suggested next round: DOMAIN-2-R01
