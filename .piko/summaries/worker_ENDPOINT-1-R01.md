...
- Deleted files: none
- Behavioral changes: Created local approved endpoint contract artifact validating fixture root shape and scope=local_approved_endpoint.
- Primary artifact: artifacts/local_endpoint/local_endpoint_contract.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/local_endpoint_contract.json"
}
`
