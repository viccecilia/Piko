...
- Deleted files: none
- Behavioral changes: Created fixture safety artifact verifying no prohibited raw/full source or credential fields and bounded snippets.
- Primary artifact: artifacts/local_endpoint/local_endpoint_fixture_safety.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/local_endpoint_fixture_safety.json"
}
`
