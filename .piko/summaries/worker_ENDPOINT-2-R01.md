...
- Deleted files: none
- Behavioral changes: Added /local-endpoint/approved-json and temporary local HTTP server surface returning approved fixture JSON.
- Primary artifact: artifacts/local_endpoint/local_endpoint_smoke.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/local_endpoint_smoke.json"
}
`
