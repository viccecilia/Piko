...
- Deleted files: none
- Behavioral changes: Added opt-in runner/context that sets PIKO_ENABLE_DISCOVERY_REAL_SOURCE, PIKO_LIVE_DISCOVERY_TEST, and local URL only inside the runner.
- Primary artifact: artifacts/local_endpoint/local_opt_in.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/local_opt_in.json"
}
`
