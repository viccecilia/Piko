...
- Deleted files: none
- Behavioral changes: Ran approved_json_endpoint live connector path against localhost endpoint with real_collection_performed=true and scope local_approved_endpoint.
- Primary artifact: artifacts/local_endpoint/local_endpoint_live_success.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/local_endpoint_live_success.json"
}
`
