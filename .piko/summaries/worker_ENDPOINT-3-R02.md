...
- Deleted files: none
- Behavioral changes: Generated normalized live signals success artifact with game/question counts and source trace.
- Primary artifact: artifacts/local_endpoint/normalized_live_signals_success.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/normalized_live_signals_success.json"
}
`
