...
- Deleted files: none
- Behavioral changes: Generated internal article handoff with source_ids, evidence_trace, outline, verification_required=true, publish_ready=false.
- Primary artifact: artifacts/local_endpoint/internal_article_handoff.json
...
`json
{
  ...
  "artifact": "artifacts/local_endpoint/internal_article_handoff.json"
}
`
