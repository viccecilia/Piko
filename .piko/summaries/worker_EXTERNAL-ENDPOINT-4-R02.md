...
- Deleted files: none
- Behavioral changes: Generated blocked candidate article package with no selected topic and publish disabled.
- Primary artifact: artifacts/external_endpoint/external_candidate_article_package.json
