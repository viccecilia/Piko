...
- Deleted files: none
- Behavioral changes: Added /external-endpoint/result and /external-endpoint/window read-only operator surfaces.
- Primary artifact: artifacts/external_endpoint/operator_external_endpoint_result.json
