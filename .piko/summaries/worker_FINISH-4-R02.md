...
- Deleted files: None.
- Behavioral changes: Added approval contract requiring human approval for publish/upload/deploy/credentials/connector activation/replacement.
