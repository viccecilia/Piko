...
- Deleted files: None.
- Behavioral changes: Generated MVP readiness artifact with mvp_ready_for_verify and all publish/deploy/raw-source flags false.
