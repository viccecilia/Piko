...
- Deleted files: none
- Behavioral changes: Generated blocked candidate-only ranking preview with publish_ready=false and publishing_performed=false.
- Primary artifact: artifacts/live_connector_pilot/candidate_only_ranking_preview.json
