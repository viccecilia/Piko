...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-1-R01.md
- Deleted files: none
- Behavioral changes: Added stable discovery score inputs, scoring matrix documentation, and boundary/decision tests.
