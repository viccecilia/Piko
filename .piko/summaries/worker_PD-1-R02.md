...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-1-R02.md
- Deleted files: none
- Behavioral changes: Covered publish_candidate, watchlist_waiting_for_answer, conflict_explainer, blocked_high_risk, and ignore decisions.
