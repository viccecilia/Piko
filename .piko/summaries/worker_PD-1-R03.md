...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-1-R03.md
- Deleted files: none
- Behavioral changes: Stabilized discovery response fields, funnel counts, next actions, and fixture CLI output.
...
- Commands run: python -m pytest tests\test_discovery_search.py -q; python -m packages.discovery.search_cli --query stardew --limit 3
- Results: passed
- Failures: none
