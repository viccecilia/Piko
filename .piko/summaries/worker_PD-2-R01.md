...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-2-R01.md
- Deleted files: none
- Behavioral changes: Documented fixture-first hot-game source categories and normalized metadata-only signals.
