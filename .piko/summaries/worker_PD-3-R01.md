...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-3-R01.md
- Deleted files: none
- Behavioral changes: Expanded question signal schema with safe metadata, language, source title, and source trace fields.
