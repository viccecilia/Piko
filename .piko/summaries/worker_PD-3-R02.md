...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-3-R02.md
- Deleted files: none
- Behavioral changes: Added short fixture questions for settings, build, quest, hidden item, and map-route needs.
