...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-3-R03.md
- Deleted files: none
- Behavioral changes: Added tests that discovery fixtures stay metadata/snippet-only and do not store raw long source text.
