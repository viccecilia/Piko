...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-4-R02.md
- Deleted files: none
- Behavioral changes: Preserved multilingual representative questions and source regions while clustering duplicate needs.
