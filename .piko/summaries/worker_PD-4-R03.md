...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-4-R03.md
- Deleted files: none
- Behavioral changes: Kept representative question, representative question list, duplicate count, and source diversity in cluster output.
