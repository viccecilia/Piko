...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-5-R02.md
- Deleted files: none
- Behavioral changes: Added evidence maturity checks and next-action routing for evidence pipeline readiness.
