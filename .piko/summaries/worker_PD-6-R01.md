...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-6-R01.md
- Deleted files: none
- Behavioral changes: Added watchlist item schema with monitor reason, next check interval, and non-publishing safety fields.
