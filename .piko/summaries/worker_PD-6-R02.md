...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-6-R02.md
- Deleted files: none
- Behavioral changes: Added watchlist trigger conversion for unanswered hot needs and promotion candidate logic.
