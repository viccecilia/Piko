...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-6-R03.md
- Deleted files: none
- Behavioral changes: Kept watchlist/promotion output candidate-only with clear publish_ready=false behavior.
