...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-7-R01.md
- Deleted files: none
- Behavioral changes: Mapped discovery clusters to article intent and source search hints without bypassing evidence pipeline.
