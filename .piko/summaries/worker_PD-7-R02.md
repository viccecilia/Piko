...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-7-R02.md
- Deleted files: none
- Behavioral changes: Added article candidate handoff object with source search hints and requires_evidence_pipeline=true.
