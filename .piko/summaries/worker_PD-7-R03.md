...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-7-R03.md
- Deleted files: none
- Behavioral changes: Enforced publish_ready=false on discovery candidates and kept article pipeline verification intact.
...
- Commands run: python -m pytest tests\test_discovery_search.py -q; python -m packages.workflows.article_pipeline
- Results: passed
- Failures: none
