...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-8-R03.md
- Deleted files: none
- Behavioral changes: Added internal /discovery/window placeholder for operator inspection, with no publishing controls.
