...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-9-R01.md
- Deleted files: none
- Behavioral changes: Documented PCGamingWiki/MediaWiki-style metadata-only real-source pilot choice for discovery.
