...
- Added files: packages/discovery/real_source.py, packages/discovery/improvement_signals.py, .piko/summaries/worker_PD-9-R02.md
- Deleted files: none
- Behavioral changes: Added disabled-by-default real-source discovery interface requiring explicit dual opt-in.
