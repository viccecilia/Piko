...
## Scope
- Allowed files touched: packages/shared/schemas.py; packages/workflows/article_pipeline.py; tests/test_stage_1.py
...
## Changes
- Modified files: packages/shared/schemas.py; packages/workflows/article_pipeline.py; tests/test_stage_1.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Unified PipelineState and WorkflowRunReport contract with JSON round-trip tests.
...
## Sample Output
`json
{"pipeline_state":{"player_question":"crash on startup","sources":["fixture_official_launch_001"],"decision":"draft_review"}}
`
