...
- Deleted files: None.
- Behavioral changes: Added PublishDecision with do_not_publish, needs_more_evidence, verification_failed, verified_candidate.
...
## Sample Output
`json
{"publish_decision":{"value":"verified_candidate","blocks_publish":false}}
`
