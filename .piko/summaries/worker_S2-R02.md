...
## Scope
- Allowed files touched: packages/agents/source_agent.py; packages/collectors/local_fixtures.py; tests/test_stage_2.py
...
## Changes
- Modified files: packages/agents/source_agent.py; packages/collectors/local_fixtures.py; tests/test_stage_2.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Source Agent deterministically selects relevant local fixture sources with ranked reasons.
...
## Sample Output
`json
{"sources":[{"source_id":"fixture_official_launch_001","reason":"Matched 4 local fixture terms"}],"real_collection_performed":false}
`
