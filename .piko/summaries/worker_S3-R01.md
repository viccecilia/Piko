...
## Scope
- Allowed files touched: packages/shared/schemas.py; packages/workflows/article_pipeline.py; tests/test_stage_3.py
...
## Changes
- Modified files: packages/shared/schemas.py; packages/workflows/article_pipeline.py; tests/test_stage_3.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Article brief includes title, problem statement, risk notes, source summary, unresolved questions, and evidence gaps.
...
## Sample Output
`json
{"article_brief":{"title":"Example Game Crash On Startup Fix","evidence_gaps":[]}}
`
