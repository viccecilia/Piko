...
## Scope
- Allowed files touched: packages/agents/writer_agent.py; tests/test_stage_3.py
...
## Changes
- Modified files: packages/agents/writer_agent.py; tests/test_stage_3.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Writer Agent emits deterministic template sections: Short Answer, Steps, Risk Notes, If It Fails, Sources.
...
## Sample Output
`json
{"sections":["short_answer","steps","risk_notes","if_it_fails","sources"],"publishing_performed":false}
`
