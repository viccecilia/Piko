...
## Scope
- Allowed files touched: packages/shared/schemas.py; packages/workflows/verification.py; tests/test_stage_4.py
...
## Changes
- Modified files: packages/shared/schemas.py; packages/workflows/verification.py; tests/test_stage_4.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added VerificationCheck, VerificationReport, VerificationStatus and strict direction checks.
...
## Sample Output
`json
{"verification_report":{"status":"pass","summary":"pass: 8/8 checks passed."}}
`
