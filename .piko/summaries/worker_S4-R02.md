...
## Scope
- Allowed files touched: packages/workflows/verification.py; packages/workflows/article_pipeline.py; tests/test_stage_4.py
...
## Changes
- Modified files: packages/workflows/verification.py; packages/workflows/article_pipeline.py; tests/test_stage_4.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Workflow attaches verification report and verifier catches missing evidence, source mismatch, and failed-gate publish-ready inconsistencies.
...
## Sample Output
`json
{"checks":[{"name":"evidence_source_trace","status":"pass"}]}
`
