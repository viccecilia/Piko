...
## Scope
- Allowed files touched: packages/collectors/mediawiki.py; packages/collectors/pcgamingwiki.py; tests/test_stage_5.py
...
## Changes
- Modified files: packages/collectors/mediawiki.py; packages/collectors/pcgamingwiki.py; tests/test_stage_5.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added opt-in MediaWiki/PCGamingWiki connector with mocked HTTP tests only.
...
## Sample Output
`json
{"source_id":"mediawiki_123","source_type":"mediawiki","trust_tier":"reference"}
`
