...
## Scope
- Allowed files touched: packages/collectors/dedup.py; tests/test_stage_5.py
...
## Changes
- Modified files: packages/collectors/dedup.py; tests/test_stage_5.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added URL/title/content-hash dedup and source trust tier assignment.
...
## Sample Output
`json
{"deduped_count":1,"trust_tier":"community"}
`
