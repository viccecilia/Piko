...
## Scope
- Allowed files touched: packages/indexing/llama_index_builder.py; packages/indexing/retrieval.py; tests/test_stage_6.py
...
## Changes
- Modified files: packages/indexing/llama_index_builder.py; packages/indexing/retrieval.py; tests/test_stage_6.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added in-memory evidence index and retrieval returning evidence ids and source ids.
...
## Sample Output
`json
{"retrieval":[{"evidence_card_id":"ev_1","source_id":"source_1"}]}
`
