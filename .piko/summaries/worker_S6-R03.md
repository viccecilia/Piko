...
## Scope
- Allowed files touched: packages/workflows/source_refresh_pipeline.py; tests/test_stage_6.py
...
## Changes
- Modified files: packages/workflows/source_refresh_pipeline.py; tests/test_stage_6.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added advisory refresh signal logic for changed source dates.
...
## Sample Output
`json
{"source_id":"source_changed","needs_refresh":true,"reason":"Source changed after article check."}
`
