...
## Scope
- Allowed files touched: apps/web/pages/guide-template.html; tests/test_stage_7.py
...
## Changes
- Modified files: apps/web/pages/guide-template.html; tests/test_stage_7.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added local mock public guide template with short answer, steps, risk notes, if-it-fails, and sources.
...
## Sample Output
`json
{"template":"apps/web/pages/guide-template.html","source_box_visible":true}
`
