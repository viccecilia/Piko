...
## Scope
- Allowed files touched: packages/shared/schemas.py; tests/test_stage_8.py
...
## Changes
- Modified files: packages/shared/schemas.py; tests/test_stage_8.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added MultiGameJob and tests ensuring workflows keep game ids and source sets separated.
...
## Sample Output
`json
{"job_id":"job_1","game_id":"game_mock_001","question_cluster":"launch issues"}
`
