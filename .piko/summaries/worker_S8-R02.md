...
## Scope
- Allowed files touched: packages/shared/token_monitor.py; packages/shared/schemas.py; packages/workflows/article_pipeline.py; tests/test_stage_8.py
...
## Changes
- Modified files: packages/shared/token_monitor.py; packages/shared/schemas.py; packages/workflows/article_pipeline.py; tests/test_stage_8.py
- Added files: See modified files list when new module/fixture/test was required for this round.
- Deleted files: None.
- Behavioral changes: Added per-component token aggregation and workflow monitoring summary fields.
...
## Sample Output
`json
{"monitoring_summary":{"status":"completed","error_count":0,"estimated_tokens":1700}}
`
