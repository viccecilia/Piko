...
- Deleted files: none
- Behavioral changes: Added adapter contract for Xiaohongshu, WeChat Official Account, and Douyin with approval_required=true and dry_run_supported=true.
...
## Sample Output
``json
{"dry_run_supported":true,"approval_required":true,"live_dispatch_default":false}
``
...
## Next Recommendation
- Suggested next round: SKILL-5-R02
