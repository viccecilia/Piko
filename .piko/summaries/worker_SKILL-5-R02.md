...
- Deleted files: none
- Behavioral changes: Added approval gate, credential policy, checklist, and sanitizer probe that redacts credential-like fields.
...
## Sample Output
``json
{"approval_status":"missing","dispatch_allowed":false,"sanitized_probe":{"token":"[REDACTED]"}}
``
...
## Next Recommendation
- Suggested next round: SKILL-5-R03
