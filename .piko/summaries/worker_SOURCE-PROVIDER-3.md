# Worker Stage Summary: SOURCE-PROVIDER-3

## Stage
- Stage ID: SOURCE-PROVIDER-3
- Stage Name: SOURCE PROVIDER source provider stage
- Rounds completed: SOURCE-PROVIDER-3-R01, SOURCE-PROVIDER-3-R02
...
- Round ID: SOURCE-PROVIDER-3-R01
  Status: completed
  Summary file: .piko/summaries/worker_SOURCE-PROVIDER-3-R01.md
  Verification commands: see final batch validation list
  Result: passed
- Round ID: SOURCE-PROVIDER-3-R02
  Status: completed
  Summary file: .piko/summaries/worker_SOURCE-PROVIDER-3-R02.md
  Verification commands: see final batch validation list
  Result: passed
