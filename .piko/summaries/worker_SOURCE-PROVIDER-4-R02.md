# Worker Summary: SOURCE-PROVIDER-4-R02

## Round
- Round ID: SOURCE-PROVIDER-4-R02
- Round Name: Operator Surface
...
- Deleted files: None.
- Behavioral changes: Added read-only /source-provider/result and /source-provider/window API surface.
